...
def check_position(centerx, centery):
    ...
    if centerx // 30 < 29:
        ...
        if direction == 2 or direction == 3:
            if 9 <= centerx % num2 <= 23:
                if level[(centery + num3) // num1][centerx // num2] < 3:
                    turns[3] = True
                if level[(centery - num3) // num1][centerx // num2] < 3:
                    turns[2] = True
            if 9 <= centery % num1 <= 23:
...
while run:
        for control in controller():
            ...
            if powerup and power_counter < 600:
                ...
                powerup = False
                eaten_ghost = [False, False, False, False]
            if startup_counter < 40 and not game_over and not game_won:
                moving = False
                startup_counter += 1
            else:
                moving = True
    ...
    #Webcam Controls
            ...
            if control == "default":
                if control == "right" and direction_command == 0:
                    direction_command = direction
                if control == "left" and direction_command == 1:
                    direction_command = direction
                if control == "up" and direction_command == 2:
                    direction_command = direction
                if control == "down" and direction_command == 3:
                    direction_command = direction
